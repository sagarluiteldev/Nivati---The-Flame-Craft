...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-creme pt-8 md:pt-16 pb-8 md:pb-10 text-olive border-t border-olive/15 transition-colors duration-700 overflow-hidden">
      
      {/* Large Brand Watermark with Overlapping Candle Images */}
      <div className="relative w-full overflow-hidden py-16 md:py-24 flex items-center justify-center border-b border-olive/10 mb-12 md:mb-16 select-none">
